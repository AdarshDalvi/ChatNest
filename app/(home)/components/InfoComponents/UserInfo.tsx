    ...
    return (
        <>
            ...
            >
                ...
                <div
                    className={clsx(
                        `absolute cursor-pointer justify-center items-center inset-0 rounded-full bg-secondary z-40 bg-opacity-50`,
            ...
            <button className="flex flex-col items-center mt-4 gap-2 hover:opacity-80">
