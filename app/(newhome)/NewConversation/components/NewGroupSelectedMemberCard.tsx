...
type NewGroupSelectedMemberCardProps = {
    selectedUser: User;
    deleteFromMember: (user: User) => void;
};

const NewGroupSelectedMemberCard: React.FC<NewGroupSelectedMemberCardProps> = ({
    selectedUser,
    deleteFromMember,
}) => {
    return (
...
export default NewGroupSelectedMemberCard;
